...
def fetch_stock_historical_data(stock, start_date, end_date):
    make_log('info', f'fetching stock historical data for {stock} in {start_date}-{end_date}')
    # Set Chrome options
    ...
    try:
        ...
        symbol = driver.find_element(By.XPATH, '/html/body/section[2]/div/form/div/div[1]/input[1]')  # Update selector
        startdate = driver.find_element(By.XPATH, '/html/body/section[2]/div/form/div/div[2]/input')  # Update selector
        enddate = driver.find_element(By.XPATH, '/html/body/section[2]/div/form/div/div[3]/input')  # Update selector
